...
export default function DaughterForm({
    ...
    newPhotoDaughterData,
    setNewPhotoDaughterData,
}: {
    headerTitle: string;
    index: number;
    daughterFormsList?: Record<string, any>[];
    setDaughterFormsList?: React.Dispatch<
        React.SetStateAction<Record<string, any>[]>
    >;
    applicationEnabled?: boolean;
    photoDaughterData?: { photo: File[] };
    setPhotoDaughterData?: React.Dispatch<
        React.SetStateAction<{ photo: File[] }>
    >;
    newPhotoDaughterData?: { photo: File[] };
    setNewPhotoDaughterData?: React.Dispatch<
        React.SetStateAction<{ photo: File[] }>
    >;
}) {
    ...
    const handleImageChange = (e) => {
        ...
        if (setNewPhotoDaughterData) {
            setNewPhotoDaughterData({ photo: [file] });
        }
                ...
                <div className="sm:flex gap-6 w-full">
                    <div className="mx-0 my-2.5 flex-1">
                        ...
                        <input
                            type="text"
                            name="region"
                            value={daughterFormsList?.[index]?.region || ""}
                            onChange={handleChange}
                    ...
                    <div className="mx-0 my-2.5 flex-1">
                        ...
                        <input
                            type="text"
                            name="city"
                            value={daughterFormsList?.[index]?.city || ""}
                            onChange={handleChange}
                            className="w-full text-base px-4 rounded-lg border-black/20 dark:border-white/20 py-2.5 border-solid border transition-all duration-500 focus:border-primary dark:focus:border-primary focus:outline-0 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500"
                            disabled={!applicationEnabled}
                        />
                ...
                <div className="sm:flex gap-6 w-full">
                    <div className="mx-0 my-2.5 flex-1">
                        ...
                        <input
                            type="number"
                            name="longitude"
                            value={daughterFormsList?.[index]?.longitude || ""}
                            onChange={handleChange}
                            className="w-full text-base px-4 rounded-lg border-black/20 dark:border-white/20 py-2.5 border-solid border transition-all duration-500 focus:border-primary dark:focus:border-primary focus:outline-0 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500"
                            disabled={!applicationEnabled}
                        />
                    ...
                    <div className="mx-0 my-2.5 flex-1">
                        ...
                        <input
                            type="text"
                            name="latitude"
                            value={daughterFormsList?.[index]?.latitude || ""}
                            onChange={handleChange}
                            className="w-full text-base px-4 rounded-lg border-black/20 dark:border-white/20 py-2.5 border-solid border transition-all duration-500 focus:border-primary dark:focus:border-primary focus:outline-0 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500"
                            disabled={!applicationEnabled}
                        />
                    ...
                    <div className="mx-0 my-2.5 flex-1">
                        ...
                        <input
                            type="text"
                            name="landmark"
                            value={daughterFormsList?.[index]?.landmark || ""}
                            onChange={handleChange}
                            className="w-full text-base px-4 rounded-lg border-black/20 dark:border-white/20 py-2.5 border-solid border transition-all duration-500 focus:border-primary dark:focus:border-primary focus:outline-0 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500"
                            disabled={!applicationEnabled}
                        />
