...
export default function Brochure() {
  ...
  return (
    <section className="hero container max-w-screen-lg mx-auto mt-25">
      <h1 className="text-3xl font-bold mb-4">{brochure.label} Brochure</h1>
      ...
      {isPdf ? (
        ...
        >
          <p className="text-center">
            ...
            <a href={brochure.file} target="_blank" rel="noopener noreferrer" className="underline">
              Open brochure
            </a>
          </p>
        </object>
      ) : (
        <img src={brochure.file} alt={`${brochure.label} Brochure`} className="w-full h-auto border" />
      )}
    </section>
  );
}
