...
export const NavLinkData: NavLinkType[] = [
  ...
  { label: "Find A Church", href: "/find-a-church" },
  {
    ...
    href: "",
    submenu: [
      { label: "Praise & Worship", href: "/chords" },
...
export const RecordData: RecordType[] = [
  {
...
export const SpecializeData: SpecializeType[] = [
  {
    title: "Evangelism",
...
export const FooterLinkData: FooterLinkType[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: "Prescott Potter's House",
        href: "https://pottershousephils.com/#:~:text=Prescott%20Potter%27s%20House",
      },
